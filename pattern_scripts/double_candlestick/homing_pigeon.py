...
# === Homing Pigeon Pattern Detection Only ===
def detect_homing_pigeon_patterns(df):
    patterns = []
    trend_cache = {}
...
def run_analysis(file):
    ...
    patterns = detect_homing_pigeon_patterns(df)

    print(f"\nDetected {len(patterns)} Homing Pigeon patterns")

    count_by_type = {'bullish_homing_pigeon': 0, 'bearish_homing_pigeon': 0}
    limit_by_type = {'bullish_homing_pigeon': 50, 'bearish_homing_pigeon': 50}
